...
module ElasticTranscoder
  class Utilities
    ...
    def initialize_headers action, options = {}
      ...
      region = amz_credentials[:region] || 'eu-west-1'
      @@host = "elastictranscoder.#{region}.amazonaws.com"
      authorization, date = ElasticTranscoder::Transcoder::Authentication.build_authorization amz_credentials[:aws_access_key_id], amz_credentials[:aws_secret_access_key], region, @@host, options[:method], action, "2012-09-25", {}, options[:payload]
