...
module ElasticTranscoder
  ...
  class Jobs
    ...
    def create_job input_key, output_key, pipeline_id, preset_id, thumbnail_pattern=nil
      action = "jobs"
      param = {
        "Input" => {
          "Key" => input_key,
      ...
      param["Output"]["ThumbnailPattern"] = thumbnail_pattern if thumbnail_pattern
      
      creation_params = param.to_json
